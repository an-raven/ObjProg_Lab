...
void output(list<Studentas> A)
{
    ...
    for (auto & i: A)
        cout << left <<setw(15) <<i.vardas << setw(15) << i.pavarde << setw(15) << setprecision(3)
            << i.GalutinisPaz(i.vid) << setw(15) << setprecision(3) << i.GalutinisPaz(i.med) << endl;
}
void input(list<Studentas>& A)
{   
    char stop;
...
void fileInput(list<Studentas>& A)
{
    fstream input;
...
void fileOutput(list<Studentas>& A, string outputFile)
{
    A.sort();
    ...
    output << "---------------------------------------------------------------------" << endl;
    for(auto & i: A)
        output << left <<setw(15) <<i.vardas << setw(15) << i.pavarde << setw(15) << setprecision(3)
            << i.GalutinisPaz(i.vid) << setw(15) << setprecision(3) << i.GalutinisPaz(i.med) << endl;
